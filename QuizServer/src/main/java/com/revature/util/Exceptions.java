...
public class Exceptions {
	...
	public static void logJsonMarshalException(IOException e, Class<?> clas) {
		logger.warn("Failed to Marshal object of type {}", clas.getName());
		logger.warn("Stack Trace: ", e);
	}

	// Unmarshalling: JSON > POJO (aka, a read)
	public static void logJsonUnmarshalException(IOException e, Class<?> clas) {
		logger.warn("Failed to Unmarshal object of type {}", clas.getName());
		logger.warn("Stack Trace: ", e);
	}
}
